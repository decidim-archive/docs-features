...
// OPCIONAL. Fecha de publicación de la versión. Por defecto se inserta automáticamente en
// este campo la fecha de generación del documento web o PDF, en formato YYYY-MM-DD. Si se
// desea, se puede sustituir "{docdate}" por una fecha manual en el formato que se quiera,
// pero a partir de ese momento se deberá actualizar también manualmente.
:revdate: {docdate}

// OPCIONAL. Ver la definición de este campo en el apartado "Criterios de autoría ..." de
// más abajo.
:_editors: Xabier E. Barandiaran, Carolina Romero

// OBLIGATORIO. Ver la definición de este campo en el apartado "Criterios de autoría ..."
// de más abajo.
